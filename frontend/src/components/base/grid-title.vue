    ...
    export default {
        ...
        created () {
            ...
            self.directionchangeHandler = () => {
                this.rtl = this.getDocumentDir() === 'rtl';
                this.compact();
            };
...
<style lang="scss" scoped>
    ...
    .title-item.cssTransforms {
        transition-property: transform;
        left: 0;
        right: auto;
    }
    .title-item.cssTransforms.render-rtl {
        left: auto;
        right: 0;
    }
    .title-item.resizing {
    ...
    .title-item.vue-draggable-dragging {
        transition:none;
        z-index: 3;
    }
    .title-item.vue-grid-placeholder {
        background: red;
        opacity: 0.2;
    ...
    .title-item > .vue-resizable-handle {
        position: absolute;
        width: 20px;
        height: 20px;
        bottom: 0;
    ...
    .title-item > .vue-rtl-resizable-handle {
        bottom: 0;
        left: 0;
